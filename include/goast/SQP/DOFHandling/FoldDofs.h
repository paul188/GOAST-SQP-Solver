...
class EnergyFoldDofGradient : public BaseOp<VectorType, MatrixType>{
    protected:
        const MeshTopologySaver &_plateTopol;
        const VectorType &_plateGeomInitial;
        const std::vector<int> &_foldVertices;
    public:
        EnergyFoldDofGradient(const MeshTopologySaver &plateTopol, const VectorType &plateGeomInitial, const std::vector<int> &foldVertices)
        :_plateTopol(plateTopol), _plateGeomInitial(plateGeomInitial), _foldVertices(foldVertices){}
